...
public class UserBehaviorTrackController extends BaseController {
    ...
    public TableDataInfo list(UserBehaviorTrackQueryDTO query) {
        ...
        rspData.setCode(com.dkd.common.constant.HttpStatus.SUCCESS);
        rspData.setMsg("查询成功");
    ...
    public com.dkd.common.core.domain.AjaxResult demoPageHelperBug(UserBehaviorTrackQueryDTO query) {
    ...
    public com.dkd.common.core.domain.AjaxResult getIncrementalData(
