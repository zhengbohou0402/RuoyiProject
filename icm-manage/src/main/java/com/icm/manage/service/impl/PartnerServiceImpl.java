...
import com.icm.manage.domain.vo.PartnerVo;
import com.icm.manage.mapper.PartnerMapper;
import com.icm.manage.service.IPartnerService;
...
public class PartnerServiceImpl implements IPartnerService
{
    ...
    public int insertPartner(Partner partner)
    {
        ...
        partner.setPassword(SecurityUtils
                .encryptPassword(partner.getPassword()));
