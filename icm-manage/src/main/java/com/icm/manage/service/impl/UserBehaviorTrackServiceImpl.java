...
import com.icm.manage.mapper.UserBehaviorWhitelistMapper;
...
public class UserBehaviorTrackServiceImpl implements IUserBehaviorTrackService {
    ...
    /**
     * 【问题复现用】走 RuoYi 通用分页 {@link com.icm.common.utils.PageUtils#startPage()}。
     *
     * 复现步骤：
     * 1. 请求带上 orderByColumn（如 daytime）和 isAsc（如 asc）参数
     * 2. {@link com.icm.common.core.page.PageDomain#getOrderBy()} 会拼出 "daytime asc"
     * 3. {@link com.icm.common.utils.PageUtils#startPage()} 内部调用
    ...
    public List<TbUserBehaviorTrackVo> demoPageHelperOrderByBug(UserBehaviorTrackQueryDTO query) {
        ...
        com.icm.common.utils.PageUtils.startPage();
